...
local Window = OrionLib:MakeWindow({Name = "YAKASHI-HUB", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "YAKASHI-HUB"})
...
W:AddLabel("[+] YAKASHI-HUB is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "YAKASHI-HUB(Noitification)",
